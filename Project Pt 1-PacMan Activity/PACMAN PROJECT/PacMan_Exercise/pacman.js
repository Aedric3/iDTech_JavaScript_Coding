...
//YEAH BABY SUCCESS LESS GOOOOO
setInterval(function () { Run(pageWidth) }, '200');
setInterval(function() {positioncounter()}, '1000')
//NOTE: x value increases when going to the right
...
function checkPageBounds(direction, imgWidth, pos, pageWidth) {
  ...
  // NOTES: img width + pos < pagewidth = moving in same direction
  //imgwidth +pos >= pagewidth = moving in opposite direction
